...
public class JobGiver_AIFroggeDefendMaster : JobGiver_AIDefendMaster
{
    ...
    protected override Job TryGiveJob(Pawn pawn)
    {
        ...
        bool allowManualCastWeapons = !pawn.IsColonist && !pawn.IsColonyMutant && !DisableAbilityVerbs;
        if (allowManualCastWeapons)
        {
            if (GetAbilityJob.Value.Invoke(this, [pawn, pawn.mindState.enemyTarget]) is Job abilityJob)
                return abilityJob;
        }
