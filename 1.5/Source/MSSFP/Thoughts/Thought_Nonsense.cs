...
public class Thought_Nonsense : Thought_Memory
{
    ...
    public override string LabelCap => cachedLabelCap ??= IncidentWorker_Nonsense.ResolveAbsoluteText(pawn, "incidentLetter", true);
    public override string Description => cachedDescription ??= IncidentWorker_Nonsense.ResolveAbsoluteText(pawn, "incidentDescription", true);
