...
public class RitualOutcomeEffectWorker_AdvanceToArcho: RitualOutcomeEffectWorker
{
    ...
    public override void Apply(float progress, Dictionary<Pawn, int> totalPresence, LordJob_Ritual jobRitual)
    {
        ...
        if (comp != null)
        {
            ...
            Find.LetterStack.ReceiveLetter(MSSFP_FormArchoMind.label, MSSFP_FormArchoMind.description, LetterDefOf.RitualOutcomePositive, lookTargets, null, null, null, null);
